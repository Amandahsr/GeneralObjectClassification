...
class AlexNet:
    def __init__(self, model_name: str):
        ...
        if model_name == "classic":
            self.model: Sequential = self.initialize_classic_model()
        elif model_name == "alexnet2":
            self.model: Sequential = self.initialize_modified_model2()
        elif model_name == "alexnet3":
            self.model: Sequential = self.initialize_modified_model3()
        elif model_name == "alexnet4":
            self.model: Sequential = self.initialize_modified_model4()
        else:
            raise ValueError("Model name is invalid. Available values are 'classic', 'alexnet2', 'alexnet3', 'alexnet4'.")
    ...
    def initialize_classic_model(self) -> Sequential:
        """
        Initializes full model layers.
        """
    ...
    def initialize_modified_model2(self) -> Sequential:
        """
        Initializes alexnet model with layer 5 removed.
        """
    ...
    def initialize_modified_model3(self) -> Sequential:
        """
        Initializes alexnet model with layer 4 removed.
        """   
        print("Initializing model")
        alexnet_model = Sequential()
    ...
    def initialize_modified_model4(self) -> Sequential:
        """
        Initializes alexnet model with layer 6 removed.
        """   
        print("Initializing model")
        alexnet_model = Sequential()
